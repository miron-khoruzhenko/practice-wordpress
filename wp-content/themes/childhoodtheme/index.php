...
<div class="aboutus" id="aboutus">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="subtitle">
                    <?php the_field('our_history_subheading_1'); ?>
                </div>
                <div class="aboutus__text">
                    <?php the_field('our_history_descr_1'); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <?php 
                    $image = get_field('our_history_img_1');
        ...
        <div class="row">
            <div class="col-lg-6">
                <?php 
                    $image = get_field('our_history_img_2');
            ...
            <div class="col-lg-6">
                <div class="subtitle">
                    <?php the_field('our_history_subheading_2'); ?>
                </div>
                <div class="aboutus__text">
                    <?php the_field('our_history_descr_2'); ?>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="subtitle">
                    <?php the_field('our_history_subheading_3'); ?>
                </div>
                <div class="aboutus__text">
                    <?php the_field('our_history_descr_3'); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <?php 
                    $image = get_field('our_history_img_3');
...
<!-- <?php
    ...
    add_action('my_hook', 'print_hello_1', 20);
    add_action('my_hook', 'print_hello_2', 10);

    add_action('another_hook', 'testFunc', 10);

    do_action('my_hook');
    do_action('another_hook', 'hello');
